...
def DecisionTree(md):
    ...
    graph.render("/Users/prakashgowdatr/Downloads/decision_tree_graphivz")
    print('Decision Tree Graph saved as decision_tree_graphivz.png')

    # Open the image using PIL
    Image.MAX_IMAGE_PIXELS = None
    img_path = "/Users/prakashgowdatr/Downloads/decision_tree_graphivz.png"
...
authors = ctk.CTkLabel(root, text="AUTHORS \n Prakash_gowda_T_R_CH22B085", bg_color='light grey', fg_color='grey18')
